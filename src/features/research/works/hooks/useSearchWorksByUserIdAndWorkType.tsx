...
export const useSearchWorksByUserIdAndWorkType = (userId: number, workType: WorkType, searchParams: SearchParams, enabled?: boolean): Result<PaginatedResults<WorkSearchDTO>> => {
    const queryKey = ["searchWorksByUserIdAndWorkType", userId, searchParams.searchTerm, searchParams.sortBy, searchParams.sortDescending, searchParams.page, searchParams.itemsPerPage];
